...
_lr_signature = 'ARROW DIVIDE ELSE EQUAL FUN IDENTIFIER IF LET LPAREN MATCH MINUS NUMBER PLUS RPAREN THEN TIMES WITHexpression : LET IDENTIFIER EQUAL expressionexpression : expression PLUS expression\n                  | expression MINUS expression\n                  | expression TIMES expression\n                  | expression DIVIDE expressionexpression : NUMBERexpression : IDENTIFIERexpression : LPAREN expression RPAREN'
...
_lr_productions = [
  ...
  ('expression -> LET IDENTIFIER EQUAL expression','expression',4,'p_assignment','parser.py',9),
  ...
  ('expression -> IDENTIFIER','expression',1,'p_expression_identifier','parser.py',27),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','parser.py',32),
]
